package io.github.bluelhf.konfig.util;
...
public class FileMonitor implements AutoCloseable {
    ...
    public BiConsumer<File, Change> getChangeConsumer() {
        return changeConsumer;
    }

    public void setChangeConsumer(BiConsumer<File, Change> changeConsumer) {
        this.changeConsumer = changeConsumer;
    }
